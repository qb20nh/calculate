...
const PuzzleView = lazy(() =>
  import('./features/puzzle/PuzzleView').then((m) => ({
    default: m.PuzzleView
  }))
)
const DailyView = lazy(() =>
  import('./features/daily/DailyView').then((m) => ({ default: m.DailyView }))
)
  ...
  return (
    ...
    >
      ...
      <Router initialView='menu'>
        ...
        >
          <PuzzleView showToast={showToast} />
        </Route>
