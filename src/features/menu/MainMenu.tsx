    ...
    return (
        ...
        ">
            <div className="max-w-2xl text-center">
                <h1 className="
                  mb-6 bg-linear-to-r from-blue-400 to-emerald-400 bg-clip-text
                  text-5xl font-extrabold tracking-tight text-transparent
                  md:text-7xl
                ">
                    Equate.
                </h1>
                ...
                <div className="mx-auto flex w-full max-w-md flex-col gap-4">
                    <button
                        ...
                        className="
                          ...
                          rounded-xl bg-blue-600 py-4 text-xl font-bold
                    ...
                    <button
                        ...
                        className="
                          flex w-full items-center justify-center gap-3
                          rounded-xl bg-emerald-600 py-4 text-xl font-bold
                          shadow-lg transition-all
                ...
                ">
                    ...
                    <ul className="list-disc space-y-2 pl-5 text-slate-300">
                        <li>Form multi-digit numbers and chain comparators (<span className="
                          font-bold text-blue-400
                        ">=, &lt;, &gt;, &lt;&gt;</span>).</li>
                        <li>Make <span className="font-bold text-blue-400">&lt;&gt;</span> (not equal) by placing <span className="
                          font-bold text-blue-400
                        ">&lt;</span> and <span className="
                          font-bold text-blue-400
                        ">&gt;</span> adjacent to each other.</li>
                        <li>At least one side of any comparison must contain a mathematical operation (<span className="
