...
export const DailyView: React.FC<DailyViewProps> = ({ onBack, showToast }) => {
    ...
    return (
        ...
        ">
            <div className="
              mb-4 flex w-full max-w-4xl items-center justify-between
            ">
                ...
                <div className="text-center">
                    ...
                    <div className="mt-1 flex items-center justify-center gap-3">
                        ...
                        <span className="
                          rounded-sm bg-emerald-500/10 px-2 py-0.5 font-mono
            ...
            ">
                ...
                ">
                    ...
                    <div
                        ...
                        className={`
                          mb-6 flex min-h-[80px] flex-wrap items-center gap-2
                          rounded-xl border bg-slate-900 p-4 shadow-inner
                          transition-colors
                    ...
                    >
                        ...
                        {dailyCurrent.length === 0 && <span className="
                          pointer-events-none ml-2 text-slate-600 italic
                        ">Drag tiles here...</span>}
                    </div>

                    <div className="flex items-center justify-between">
                        <button onClick={clearBuilder} className="
                        ...
                        <button
                            ...
                            className="
                              rounded-xl bg-blue-600 px-8 py-3 font-bold
                ...
                {/* Pool Area */}
                <div data-dropzone="pool" className={`
                ...
                ">
                    ...
                    "><Trophy className="text-yellow-400" /> Discovered Statements ({dailySubmitted.length})</h3>
                    {dailySubmitted.length === 0 ? (
                        ...
                        <div className="flex flex-col gap-3">
                            {dailySubmitted.map((stmt) => (
                                <div key={stmt} className="
                                  rounded-lg border border-slate-600
                                  bg-slate-800 px-4 py-3 font-mono text-xl
                                  tracking-widest text-emerald-300 shadow-sm
                                ">
                                    {stmt}
                                </div>
                            ))}
